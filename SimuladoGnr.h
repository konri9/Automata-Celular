...
template < typename V >
GrafoGnr::E GrafoGnr::obtEst(int vrt) const
{
    if (xstVrt(vrt) == true)
    {
        return arrVrt[vrt].e;
...
template < typename V >
int GrafoGnr::obtTmpChqVrs(int vrt) const
{
    return arrVrt[vrt].tmpChqVrs;
}

template < typename V >
int GrafoGnr::obtCntChVrs(int vrt)const {
...
template < typename V >
void GrafoGnr::modEst(int vrt, E ne)
{
    if (xstVrt(vrt))
    {
        arrVrt[vrt].e = ne;
...
template < typename V >
void GrafoGnr::modTmpChqVrs(int vrt, int nt)
{
...
template < typename V >
void GrafoGnr::actCntChqVrs(int vrt)
{
...
template < typename V >void GrafoGnr::infectar(int ios)
{
    if (ios < obtTotVrt())
    {
...
template < typename V >
void GrafoGnr::azarizarTmpChqVrs(int vcf)
{
    int randy;
